...
def compress_histogram(histogram, new_size=(15, 15)):
...
def plot_predicted_landscape_for_temp_conc(m, scaler, temp, conc):
    predicted_landscape = np.zeros((15, 15))
    for i in range(15):
        for j in range(15):
...
def find_and_plot_compressed_histogram(temps, concs, histograms, temp_val, conc_val, new_size=(15, 15)):
